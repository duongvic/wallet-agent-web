...
public class ChartRowItem implements Serializable {
  ...
  public ChartRowItem(String header, String faceValue, Long cardInputted, Long cardSold, long cardActivate,
      long cardDeactivate, long cardPreExpired, long cardExpired) {
    this.header = header;
  ...
  public ChartRowItem(String cardType, String faceValue, long cardInputted, long cardSold, long cardActivate,
      long cardDeactivate, long cardPreExpired, long cardExpired, long levelWarning) {
