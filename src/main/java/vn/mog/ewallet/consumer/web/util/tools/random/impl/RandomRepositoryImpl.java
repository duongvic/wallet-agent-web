package vn.mog.ewallet.consumer.web.util.tools.random.impl;
...
import vn.mog.ewallet.consumer.web.util.tools.random.IRandomRepository;

@Service
public final class RandomRepositoryImpl implements IRandomRepository {

  protected static final Logger LOG = LogManager.getLogger(RandomRepositoryImpl.class);
