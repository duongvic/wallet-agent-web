...
public class TransactionCancel1 {
  ...
  public TransactionCancel1(Long id, Date createdDate, String service, String merchant, String requester,
      Long amount, Long fee, Long totalAmount, Long preBalance, Long postBalance, Integer status,
      String approver, Integer process) {
    this.id = id;
