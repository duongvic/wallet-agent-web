...
public class WalletTransferOrderFlowStage {
  ...
  public static final int OPERATION_INIT = 0;//, "Operation staff initiated"),
  public static final int FINANCE_REJECTED = 1;//, "Finance staff rejected"),
  public static final int FINANCE_READY_TO_VERIFIED = 2;//, "Ready to verified by Finance Staff"),
  public static final int FINANCE_LEADER_REJECTED = 3;//, "Finance Leader rejected"),
  public static final int FINANCE_LEADER_READY_TO_REVIEWED = 4;//, "Ready to reviewed by Finance Leader"),
  public static final int FINANCE_MANAGER_REJECTED = 5;//, "Finance Manager rejected"),
  public static final int FINANCE_MANAGER_READY_TO_APPROVED = 6;//, "Ready to approved by Finance Manager"),
  public static final int FINISHED = 8;//, "Finance Manager approved. Finish!");
