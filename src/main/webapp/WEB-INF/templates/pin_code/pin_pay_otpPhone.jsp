...
<c:set var="userLoginType" value="<%=userLogin.getCustomerTypeId()%>" scope="application"/>
<c:set var="AGENT_TYPE" value="<%=CustomerType.ID_AGENT%>" scope="application"/>
  ...
  <div class="page-content container-fluid">
    <div class="row">
      <div class="col-md-7">
        <div class="panel panel-bordered">
          <div class="panel-body py-10">
            ...
            <form id="confirm-form" class="form-horizontal" method="post" action="/pin-code/pin-pay-confirm">
      ...
      <div class="col-md-5">
        <!-- Giao dịch gần nhất -->
        <c:import
            url="../include_component/frame_information_transaction_pincode.jsp"/>
        <!-- /Giao dịch gần nhất  -->
      </div>
    </div>
  </div>
