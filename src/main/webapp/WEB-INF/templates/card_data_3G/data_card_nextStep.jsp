          ...
          <div class="panel-body py-10">
            ...
            <form class="form-horizontal">
              ...
              <div class="form-group row mb-10 ">
                ...
                <div class="col-6 col-sm-7 col-md-9">
                  <label class="" id="soDuVi" name="soDuVi">${ewallet:formatNumber(userLogin.balance)} đ</label>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-9 offset-md-3">
                  <a class="btn btn-primary btn-sm pull-right" href="/game-code/buy-game-card">
