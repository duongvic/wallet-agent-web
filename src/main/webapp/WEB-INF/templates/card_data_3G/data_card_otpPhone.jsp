  ...
  <div class="page-content container-fluid">
    <div class="row">
      <div class="col-md-7">
        <div class="panel panel-bordered">
          <div class="panel-body py-10">
            ...
            <form id="confirm-form-data-card" class="form-horizontal" method="post"
                  action="/card-data/pin-pay-confirm">
      ...
      <div class="col-md-5">
        <!-- Giao dịch gần nhất -->
        <c:import
            url="../include_component/frame_information_transaction_pincode_datacard.jsp"/>
        <!-- /Giao dịch gần nhất  -->
      </div>
    </div>
  </div>
