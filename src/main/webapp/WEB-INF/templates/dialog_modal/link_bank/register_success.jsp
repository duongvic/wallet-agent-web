...
<div class="modal fade modal-fall" id="modalPaymentRegisterSuccess" aria-hidden="true"
          ...
          <div class="panel panel-bordered">
            ...
            <div class="panel-body text-center mb-10">
              <div class="form-group row">
                <label class="col-sm-12 form-control-label"><spring:message code="register.online.payment.success"/> </label>
              </div>
