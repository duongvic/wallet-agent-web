...
<spring:message code="label.payee.name" var="label_payee_name"/>
<spring:message code="label.invalid.cashout.amount" var="label_invalid_amount"></spring:message>
<spring:message code="label.enter.otp" var="label_enter_otp"></spring:message>
<spring:message code="label.code.to.receive.money" var="label_receive_money"/>
    ...
    <div class="row">
      <div class="col-12">
        <div class="panel panel-bordered">
          <form id="myForm" action="/cashout-viettel-pay/info" method="post">
            ...
            <div class="panel-body py-10">
              ...
              <div class="row mb-10">
                <div class="col-lg-12 col-md-8 mb-3">
                  <label>
                    ...
                    <spring:message code="label.payee.is.phone.number"/>
                  </label>
                </div>
                <div class="col-lg-12 col-md-8 mb-3 offset-md-0">
                  <div class="input-group">
                    <input type="text" id="receiverMsisdn"
                           name="receiverMsisdn"
                           class="form-control"
                           onchange="getValueReceiverMsisdn(this)"
                           pattern="[0-9]{10}"
                ...
                <div class="errorReceiverMsisdn"></div>
              </div>
              ...
              <div class="row mb-10">
                <div class="col-lg-12 col-md-8 mb-3">
                  <label>
                    <strong style="color: red">*</strong>&nbsp;<spring:message code="label.payee.name"/>
                  </label>
                </div>
                <div class="col-lg-12 col-md-8 mb-3 offset-md-0">
                  <div class="input-group">
                    <input type="text" id="receiverName"
                           name="receiverName"
                           class="form-control"
                           onchange="getValuePayee(this)"
                           required
                    >
                  </div>
                </div>
                <div class="errorPayee"></div>
              </div>
              ...
              <div class="row mb-10">
                <div class="col-lg-12 col-md-8 mb-3">
                  <label>
                    <strong style="color: red">*</strong>&nbsp;${label_receive_money}
                  </label>
                </div>
                <div class="col-lg-12 col-md-8 mb-3 offset-md-0">
                  <div class="input-group">
                    <input type="text" id="receiptCode"
                           name="receiptCode"
                           class="form-control"
                           onchange="getValueReceiptCode(this)"
                           required
                    >
                  </div>
                </div>
                <div class="errorReceiptCode"></div>
              </div>
              ...
              <div class="row mb-10">
                <div class="col-lg-12 col-md-8 mb-3">
                  <label>
                    <strong style="color: red">*</strong>&nbsp;
                    <spring:message code="fundout.order.request"/>
                  </label>
                </div>
                <div class="col-lg-12 col-md-8 mb-3 offset-md-0">
...
<script type="text/javascript">
  ...
  //   var valPayeePhone = document.getElementById("receiverMsisdn").value;
  //   if ($(this).is(':checked')) {
  //     booleanSendMe = true;
  ...
  //-----------isValid dữ liệu-----------------
  function getValueReceiverMsisdn(elem) {
    var _requestId = elem.value.trim();
    if (_requestId.length < 10) {
      var $newErrorPayeePhone = $("<div id=\"new-receiver-phone-error\">\n"
        + "              <div class=\"col-12\">\n"
      ...
      $('.errorReceiverMsisdn').html($newErrorPayeePhone);
    }
    else {
      $('.errorReceiverMsisdn').empty();
    }
  }

  function getValuePayee(elem) {
    ...
    if (_requestId.length === 0) {
      var $newErrorPayer = $("<div id=\"new-payer-error\">\n"
        ...
        + "                <div class=\"text-danger error-message mb-10\">\n"
        + "                  <small><i class=\"fa fa-times-circle\"></i>&nbsp;"
        + "${label_invalid_input} ${label_payee_name}" + " </small>\n"
        + "                </div>\n"
        + "              </div>\n"
        + "            </div>");

      $('.errorPayee').html($newErrorPayer);
    }
  ...
  function getValueReceiptCode(elem) {
    var _requestId = elem.value;
    if (_requestId.length === 0) {
      var $newErrorReceiptCode = $("<div id=\"new-receipt-code-error\">\n"
        + "              <div class=\"col-12\">\n"
        + "                <div class=\"text-danger error-message mb-10\">\n"
        + "                  <small><i class=\"fa fa-times-circle\"></i>&nbsp;"
        + "${label_invalid_input} ${label_receive_money}" + " </small>\n"
        + "                </div>\n"
        + "              </div>\n"
        + "            </div>");

      $('.errorReceiptCode').html($newErrorReceiptCode);
    }

    else {
      $('.errorReceiptCode').empty();
    }
  }

  //-----------end isValid dữ liệu-----------------

  function paymentClick() {
    var inpPayeePhone = document.getElementById("receiverMsisdn").value;
    var inpPayee = document.getElementById("receiverName").value;
    var inpReceiptCode = document.getElementById("receiptCode").value;
    ...
    if (checkLength(inpPayee) == false) {
      var $newErrorPayee = $("<div id=\"new-payer-error\">\n"
        + "              <div class=\"col-12\">\n"
        + "                <div class=\"text-danger error-message mb-10\">\n"
        + "                  <small><i class=\"fa fa-times-circle\"></i>&nbsp;"
        + "${label_invalid_input} ${label_payee_name}" + " </small>\n"
      ...
      $('.errorPayee').html($newErrorPayee);
      return false;
    }
    if (checkLength(inpReceiptCode) == false) {
      var $newErrorReceiptCode = $("<div id=\"new-payer-error\">\n"
        + "              <div class=\"col-12\">\n"
        + "                <div class=\"text-danger error-message mb-10\">\n"
        + "                  <small><i class=\"fa fa-times-circle\"></i>&nbsp;"
        + "${label_invalid_input} ${label_receive_money}" + " </small>\n"
  ...
  <%--var inpPayer = document.getElementById("receiverName").value;--%>
  <%--var inpPayerPhone = document.getElementById("receiverMsisdn").value;--%>
  <%--// var inpPayeePhone = document.getElementById("receiverMsisdn").value;--%>
  ...
  <%--receiverName: inpPayer,--%>
  <%--receiverMsisdn: inpPayerPhone,--%>
  ...
  function checkAmount(inpAmount) {
    ...
    if (inpAmount === 0 || inpAmount < 50000 || inpAmount > 50000000) return false;
    return true;
  }
