    ...
    background-color: #fff;">
        <div class="login-box">
          <div class="login-box-body">
            ...
            <form id="change_password_form" action="/customer/change-password/confirm"
                  method="post">
              ...
              <div class="form-group has-feedback">
                <input class="form-control" type="password" name="password" id="password"
                       placeholder="${enterPass}" required/>
                <input class="form-control" type="password" name="re_password" id="re_password"
                       placeholder="${reEnterPass}" required/>
              </div>
              <div class="form-group">
                <div class="pull-right">
                  <button type="submit" class="btn btn-primary btn-sm pull-right" autofocus>
                    <spring:message
                        code="common.btn.update"/></button>
                </div>
              </div>
