...
<c:set value="<%=TypicalResendOtp.FORGOT_PASSWORD.getCode()%>" var="OTP_TYPE"/>
          ...
          <div class="login-box-body">
            ...
            <form action="change-password" method="post">
              ...
              <div class="form-group text-left">
                <%--<spring:message code="label.pl.enter.authen.code.sent.phone"/>&nbsp; ${user_name != null ? ewallet:encodePhone(user_name) : '--'}--%>
                  <spring:message code="label.pl.enter.authen.code.sent.email"/>
              </div>
              ...
              <div class="form-group">
                ...
                <small id="resend" class="resend hidden pull-right"
                       data-url="/ajax-controller/customer/security/resend-otp/${OTP_TYPE}/${user_name}"><spring:message code="label.could.not.get.code"/> <a href="#"><spring:message code="label.resend"/></a></small>
                <br class="clr"/>
              </div>
