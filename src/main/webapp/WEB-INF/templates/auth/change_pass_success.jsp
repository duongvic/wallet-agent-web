    ...
    background-color: #fff;">
        <div class="login-box">
          <div class="login-box-body">
            ...
            <br class="clr"/>
            <div class="row mb-20">
              <h4><spring:message code="changepass.nav.change.pass"/></h4>
            </div>
            <div class="row mb-20">
              <div
                ...
                <br class="clr"/>
                <p class="mb-0"><spring:message code="lable.change.pass.success"/></p>
                <br>
              </div>
            </div>
            <div class="clr"></div>
            <div class="row justify-content-center">
              <div class="form-inline">
                <div class="form-group">
                  <a href="/logout" class="btn btn-primary btn-sm"><spring:message code="common.btn.back.login"/>
                  </a>
                </div>
              </div>
            </div>
