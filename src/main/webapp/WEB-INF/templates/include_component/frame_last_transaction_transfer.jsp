...
<div class="panel panel-bordered">
  <div class="panel-body py-10">
    ...
    <div class="form-group row mb-10 small">
      ...
      <c:forEach var="item" items="${listTransactionsTransfer}">
        <div class="col-sm-8 col-md-8 bg-gray py-10">
         <spring:message code="label.moneytransfer"/>
          <br/>
            ${item.serviceName}
        </div>
        <div class="col-sm-4 col-md-4 bg-gray py-10 text-right">
