...
<div class="panel panel-bordered">
  <div class="panel-body py-10">
    ...
    <div class="form-group row mb-10 small">
      ...
      <c:forEach var="item" items="${listTransPinCode}">
        <div class="col-6 bg-gray py-10">
          <div class="row form-group">
            <div class="col-3">
              <img src="/assets/images/icon/${item.cardType}.png" style="width: 30px; height: 30px; border: 1px solid #ced8dc; border-radius: 30px;" onerror="imgError(this)">
            </div>
            <div class="col">
                ${item.serviceName}
              <br/>
