...
<div class="panel panel-bordered">
  ...
  <div class="form-group row mb-10">
    <h4 class="panel-title pl-0"><spring:message code="label.transaction.recent"/></h4>
  </div>
  <div class="form-group row mb-10 ">
    ...
    <div class="col col-sm-6 col-md-6">
      <label><spring:message code="label.fundin.atm"/></label>
    </div>
  </div>
  <div class="form-group row mb-10 ">
    <div class="col col-sm-6 col-md-6">
  ...
  <div class="form-group row mb-10 ">
    <div class="col col-sm-6 col-md-6">
      <label><spring:message code="label.discount"></spring:message> :</label>
    </div>
    <div class="col col-sm-6 col-md-6">
      <label>5%</label>
    </div>
