...
<div class="panel panel-bordered">
  ...
  <div class="form-group row mb-10 ">
    ...
    <div class="col col-sm-6 col-md-6">
      <label><spring:message code="label.topUp"/></label>
    </div>
  </div>
  <div class="form-group row mb-10 ">
    <div class="col col-sm-6 col-md-6">
    ...
    <div class="form-group row mb-10 ">
      <div class="col col-sm-6 col-md-6">
        <label><spring:message code="label.actor"/>:</label>
      </div>
      <div class="col col-sm-6 col-md-6">
  ...
  <div class="form-group row mb-10 ">
    ...
    <div class="col col-sm-6 col-md-6">
      ...
      <%--<input type="hidden" name="disCount" id="feeAmount" value="${feeAmount}">--%>
    </div>
  </div>
  <div class="form-group row mb-10 ">
    <div class="col col-sm-6 col-md-6">
    ...
    <div class="col col-sm-6 col-md-6">
      <label>${ewallet:formatNumber(fee != null ? fee : 0)}&nbsp;Zpoint</label>
