...
<head>
  <title><spring:message code="label.fundin.visa"/> - <spring:message code="common.company"/></title>
  <!-- head libs  -->
...
<div class="page page-email">
  <div class="page-header">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><spring:message code="label.fundin.visa"/></li>
    </ol>
    <h3 class="page-title"><spring:message code="label.fundin.visa"/></h3>
  </div>
      ...
      <div class="col-md-12">
        <div class="panel panel-bordered">
          <div class="panel-body py-10">
            ...
            <form class="form-horizontal" method="post" action="/fundin/visa/info">
              ...
              <div class="row justify-content-center">
                <div class="form-inline">
                  <div class="form-group">
                    <button class="btn btn-primary btn-sm"><spring:message code="common.btn.try.again"/>
                    </button>
                  </div>
                </div>
              </div>
