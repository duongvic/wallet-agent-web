<%@ page
        import="static vn.mog.ewallet.consumer.web.controller.fundin.FundInLinkBankController.FUNDIN_LINKBANK_PREFIX" %>
...
<spring:message code="label.email" var="placeholderEmail"/>
<spring:message code="label.phone.number" var="placeholderPhone"/>
...
<div class="page">
                    ...
                    <div class="panel panel-bordered">
                        <div class="panel-body py-10">
                            <form class="form-horizontal" method="post"
                                  action="/fundin/visa/request">
                                <div class="form-group row mb-10">
                                    <div class="full-width">
                                        <img alt="${bankCode}"
                                             src="/assets/images/visa/${_nameBank}.png" align="left"
                                             width="100"
                                ...
                                <div class="form-group row mb-10 pos-relative">
                                    <label class="col-2"><spring:message code="table.card.amout"/> &nbsp;<strong style="color: red">*</strong>:</label>
                                    <div class="col">
                                        ...
                                        <div class="price-radio mt-5">
                                            ...
                                            <div class="radio-custom radio-info radio-inline text-center">
                                                <input type="radio" id="sdtt4" name="numberdt2"
                                                       value="1000000" ${(amount == null || amount eq '' || amount eq '1000000') ? 'checked' : ''}
                                                       onclick="getSoTienRut(this)">
                                ...
                                <div class="form-group row mb-10 pos-relative">
                                    <label class="col-2"><spring:message code="label.fee"/>:</label>
                                    <div class="col">
                                        <span class="txt-note-pin" id="feeAmount">0 đ</span>
                                ...
                                <div class="form-group row mb-10">
                                    <label class="col-2"><spring:message
                                            code="label.amount"/>:</label>

                                    <label class="col"><b class="text-amount"
                                ...
                                <div class="form-group row mb-10 pos-relative hidden">
                                    <label class="col-2"><spring:message code="label.phone.number"/> &nbsp;<strong style="color: red">*</strong>:</label>
                                    <div class="col">
                                        <input type="text" class="form-control" placeholder="placeholderPhone"
                                               id="_soTaiKhoan" name="_soTaiKhoan"
                                               value="${_soTaiKhoan != null && _soTaiKhoan ne '' ? _soTaiKhoan : userLogin.phoneNumber}"
                                               />
                                        <%--<label--%>
                                        <%--class="form-control-label px-0 label-control-right">${userLogin.username}</label>--%>
                                        <div class="price-radio mt-5 hidden">
                                            <div class="radio-custom radio-info radio-inline text-center">
                                                <input type="radio" id="sdt1"
                                                       name="phoneNumber" ${(_soTaiKhoan == null || (_soTaiKhoan eq userLogin.phoneNumber)) ? 'checked' : ''}
                                ...
                                <div class="form-group row mb-10 hidden">
                                    <label class="col-2"><spring:message
                                            code="label.email"/>&nbsp;<strong style="color: red">*</strong>:</label>
                                    <div class="col">
                                        <input type="text" class="form-control"
                                               pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[a-z]{2,3}$"
                                               id="email"
                                               value="${email != null && email ne '' ? email : userLogin.email}"
                                               name="email"
    ...
    <script>
      ...
      function thanhToan() {
        ...
        var feeAmount = parseFloat(
            currencyToNumber(document.getElementById('feeAmount').innerText));
        if (feeAmount > amount) {
          realAmount = 0;
        }
        else {
