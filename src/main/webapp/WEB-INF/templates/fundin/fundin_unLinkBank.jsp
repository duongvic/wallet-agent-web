...
<div class="page">
  <div class="page-header">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Nạp tiền / <spring:message code="label.fundin.no.link.bank"/></li>
    </ol>
    <h1 class="page-title">Nạp tiền qua ngân hàng</h1>
  </div>
        ...
        <div class="col-md-7">
          <div class="panel panel-bordered">
            <div class="panel-body py-10">
              <form class="form-horizontal" method="post" action="/fundin/linkbank/verifyLinkBank">
                <div class="form-group row mb-10">
                  <div class="full-width">
                    <img alt ="${bankCode}"src="/assets/images/bank/${bankName}.png" align="left" width="100"
                ...
                <div class="row">
                  <div class="col-md-9 offset-md-3">
                    <button type="submit" class="btn btn-primary btn-sm pull-right"> Nạp tiền
                    </button>
                  </div>
                </div>
...
//
    ...
    function thanhToan() {
      ...
      var feeAmount = parseFloat(document.getElementById('feeAmount').innerText);
