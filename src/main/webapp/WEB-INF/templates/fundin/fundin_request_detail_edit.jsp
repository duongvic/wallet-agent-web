...
<div class="page">
    ...
    <div class="page-content container-fluid">
        <form method="post" enctype="multipart/form-data" id="mainform"
              action="/fundin/${fund_in_method}/management/detail/${requestId}/edit-submit">
            <div class="panel mb-0 panel-bordered">
                <div class="panel-body">
                    ...
                    <div class="form-group row mb-5">
                        ...
                        <div class="col-sm-4 ">
                            <div id="mobileFundIn" class="price-radio mt-5 item-responsive">
                    ...
                    <div class="form-group row mb-5">
                        ...
                        <div class="col-sm-4">
                            ...
                            <a class="btn btn-primary btn-sm pull-right mr-2"
                               href="/fundin/${fund_in_method}/management/detail/${request_id}"><spring:message
