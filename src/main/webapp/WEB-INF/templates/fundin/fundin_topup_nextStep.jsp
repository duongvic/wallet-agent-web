      ...
      <div class="col-md-7">
        <div class="panel panel-bordered">
          <div class="panel-body py-10">
            ...
            <form class="form-horizontal" method="post" action="/fundin/topup/topUpNextStepVerify">
              ...
              <div class="form-group row mb-10 ">
                ...
                <div class="col-6 col-sm-7 col-md-10">
                  <label class="" name="taiKhoan">${taiKhoan}</label>
                </div>
              </div>
              ...
              <div class="form-group row mb-10 ">
                ...
                <div class="col-6 col-sm-7 col-md-10">
                  <label class="" id="soDuVi" name="soDuVi">${ewallet:formatNumber(soDuVi)}</label>
                </div>
              </div>
