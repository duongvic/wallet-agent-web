...
<div class="page">
  ...
  <div class="page-content container-fluid">
    ...
    <div class="panel mb-0 panel-bordered">
        ...
        <div class="panel-body">
          ...
          <div class="form-group row telco gr-logo">
            ...
            <c:if test="${enabledServices != null}">
              <c:forEach var="trueService" items="${enabledServices}" varStatus="index">
                ...
                <div class="col-xs-6 col-sm-4 col-md-2">
                  <label for="rd${index.count}" class="lb-image">
                    ...
                    <br/>
                    <input id="rd${index.count}" name="telco" value="${CardType.getCardType(trueService.serviceCodeName)}"
          ...
          <%--start table normal-type--%>
          <div class="form-group row tb-facevalue normal-type-tb">
          ...
          <div class="form-group row mobifone-type-tb tb-facevalue hidden">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group row textTelco mt-20">
              <!-- 1000 -->
              <label class="col-4"><spring:message code="label.price"/>:<span
                  class="fr">1.000 đ</span> </label>
              <div class="col-4"><input type="text" name="tc_am1"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label
                  class="col-4  pl-none pr-none secondary_color tc_am1 "><spring:message
                  code="card.label.discount"/></label>


              <!-- 20000 -->
              <label class="col-4"><spring:message code="label.price"/>:<span
                  class="fr">3.000 đ</span>
              </label>
              <div class="col-4"><input type="text" name="tc_am3"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label
                  class="col-4 pl-none pr-none secondary_color tc_am3 "><spring:message
                  code="card.label.discount"/></label>

              <!-- 30000 -->
              <label class="col-4"><spring:message code="label.price"/>:<span
                  class="fr">10.000 đ</span>
              </label>
              <div class="col-4"><input type="text" name="tc_am10"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
              ...
              <%--42.000--%>
              <label class="col-4 "><spring:message code="label.price"/>:<span
                  class="fr">42.000 đ</span> </label>
              <div class="col-4"><input type="text" name="tc_am42"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label
                  class="col-4 pl-none pr-none  secondary_color tc_am42 "><spring:message
                  code="card.label.discount"/></label>
              <%--84.000--%>
              <label class="col-4 "><spring:message code="label.price"/>:<span
                  class="fr">84.000 đ</span> </label>
              <div class="col-4"><input type="text" name="tc_am84"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label
                  class="col-4 pl-none pr-none  secondary_color tc_am84 "><spring:message
                  code="card.label.discount"/></label>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group row textTelco mt-20">
              <label class="col-4 "><spring:message code="label.price"/>:<span
                  class="fr">2.000 đ</span> </label>
              <div class="col-4"><input type="text" name="tc_am2"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label
                  class="col-4 pl-none pr-none  secondary_color tc_am2 "><spring:message
                  code="card.label.discount"/></label>

              <%--5000--%>
              <label class="col-4 "><spring:message code="label.price"/>:<span
                  class="fr">5.000 đ</span> </label>
              <div class="col-4"><input type="text" name="tc_am5"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label class="col-4 pl-none pr-none  secondary_color tc_am5 ">
                <spring:message code="card.label.discount"/></label>

              <%--14000--%>
              <label class="col-4 "><spring:message code="label.price"/>:<span
                  class="fr">14.000 đ</span> </label>
              <div class="col-4"><input type="text" name="tc_am14"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label class="col-4 pl-none pr-none  secondary_color tc_am14 ">
                <spring:message code="card.label.discount"/></label>

              <%--28000--%>
              <label class="col-4 "><spring:message code="label.price"/>:<span
                  class="fr">28.000 đ</span> </label>
              <div class="col-4"><input type="text" name="tc_am28"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label
                  class="col-4 pl-none pr-none  secondary_color tc_am28 "><spring:message
                  code="card.label.discount"/></label>

              <%--56000--%>
              <label class="col-4 "><spring:message code="label.price"/>:<span
                  class="fr">56.000 đ</span> </label>
              <div class="col-4"><input type="text" name="tc_am56"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label
                  class="col-4 pl-none pr-none  secondary_color tc_am56 "><spring:message
                  code="card.label.discount"/></label>
            </div>
          ...
          <div class="form-group row vinaphone-type-tb tb-facevalue hidden">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group row textTelco mt-20">
              ...
              <!-- 120000 -->
              <label class="col-4"><spring:message code="label.price"/>:<span
                  class="fr">120.000 đ</span>
              </label>
              <div class="col-4"><input type="text" name="tc_am120"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label
                  class="col-4 pl-none pr-none secondary_color tc_am120 "><spring:message
                  code="card.label.discount"/></label>
            </div>
            <%--50000--%>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group row textTelco mt-20">
              ...
              <div class="col-4"><input type="text" name="tc_am100"
                                        ...
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label class="col-4 pl-none pr-none  secondary_color tc_am100">
                <spring:message code="card.label.discount"/></label>

              <%--150000--%>
              <label class="col-4 "><spring:message code="label.price"/>:<span
                  class="fr">150.000 đ</span> </label>
              <div class="col-4"><input type="text" name="tc_am150"
                                        placeholder="${inventory_label}"
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label class="col-4 pl-none pr-none  secondary_color tc_am150 ">
                <spring:message code="card.label.discount"/></label>
            </div>
          ...
          <div class="form-group row viettel-type-tb tb-facevalue hidden">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group row textTelco mt-20">
              ...
              <div class="col-4"><input type="text" name="tc_am5"
                                        ...
                                        class="form-control po-line inputtelco"></div>
              <label
                  class="col-4  pl-none pr-none secondary_color tc_am5 "><spring:message
                  code="card.label.discount"/></label>
          ...
          <div class="form-group row scoin-type-tb tb-facevalue hidden">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group row textTelco mt-20">
              ...
              <div class="col-4"><input type="text" name="tc_am5000"
                                        ...
                                        class="form-control po-line inputtelco"></div>
              <label
                  class="col-4 pl-none pr-none  secondary_color tc_am5000 "><spring:message
                  code="card.label.discount"/></label>
            </div>
          ...
          <div class="form-group row funcard-type-tb tb-facevalue hidden">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group row textTelco mt-20">
              ...
              <div class="col-4"><input type="text" name="tc_am500"
                                        ...
                                        autocomplete="off"
                                        class="form-control po-line inputtelco"></div>
              <label class="col-4 pl-none pr-none  secondary_color tc_am500 ">
                <spring:message code="card.label.discount"/></label>
              <%--2000000--%>
              <label class="col-4 "><spring:message code="label.price"/>:<span
                  class="fr">2.000.000 đ</span> </label>
      ...
      <form name="telco" action="edit-po" method="post">
        <div class="panel-body tb-tool">
          ...
          <input type="hidden" name="poMerchantId"
                 value="${param.id != null ? param.id : poMerchantId }"/>
          ...
          <section class="panel panel-default po-detail-line" style="box-shadow: none">
            ...
            <div class="pl-xs" style="font-size: 13px;">
              ...
              <spring:message code="service.exportcard.edit.table.header.totalmoney"/>&nbsp; <b
                class="b-money primary_color">${purchaseOrder.totalValue}</b> <b
                class="primary_color">VND</b>&nbsp;|&nbsp;
              <spring:message code="service.exportcard.edit.table.header.quantity"/>&nbsp; <b
                class="b-quantity primary_color">${purchaseOrder.totalQuantity}</b>
            </div>
                ...
                <table class="table table-bordered table-striped mb-none" id="tableMPOdetail">
                  ...
                  <c:forEach var="item" items="${purchaseOrderDetails }" varStatus="varStatus">
                    <tr class="${item.cardType}_${item.faceValue}">
                      ...
                      <input type="hidden" class="hidden" name="status_${varStatus.index+1}"
                             value="${item.status }"/>

                      <td class="stt">${varStatus.index+1}</td>
                      <td>${item.cardType} <input type="hidden" name="telco_${varStatus.index+1}"
                                                  value="${item.cardType }"/></td>
                      <td class="text-right">${ewallet:formatNumber(item.faceValue)} <input
                          type="hidden" name="value_${varStatus.index+1}"
                          value="${item.faceValue }"/></td>
                      <td class="text-right">${ewallet:formatNumber(item.quantity)} <input
                          type="hidden" name="quantity_${varStatus.index+1}"
    ...
    $('input[name=telco]').click(function () {
      ...
      $.get('getAvailabelCard', {cardtype: telco}, function (data) {
        ...
        var valArray = [10000, 20000, 30000, 50000, 100000, 200000, 300000, 500000, 1000000,
          2000000, 5000000, 1000, 2000, 3000, 5000, 14000, 28000, 42000, 56000, 84000, 70000,
          120000,
          150000];
