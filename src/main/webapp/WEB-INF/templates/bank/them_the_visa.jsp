...
<head>
  <title>Thêm thẻ ngân hàng - <spring:message code="common.company"/></title>
  <!-- head libs  -->
        ...
        <form action="themTheVisa" method="post">
          <div class="form-group row">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="inputCredit" name="inputCredit" data-plugin="formatter" data-pattern="[[9999]]-[[9999]]-[[9999]]-[[9999]]"/>
