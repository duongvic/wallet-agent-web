...
<div class="page">
  <div class="page-header">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a href="quanlythe.html"><spring:message code="topup.page.title"/></a></li>
    </ol>
  ...
  <div class="page-content container-fluid">
    <div class="row">
      <div class="col-md-7">
        <div class="panel panel-bordered">
          <div class="panel-body py-10">
            ...
            <form class="form-horizontal" method="get" action="/topup/topUpNextStep">
              ...
              <div class="form-group row mb-10">
                <label class="control-label col-sm-4 col-md-3 col-lg-2" style="margin-left: 2.5em;" for="taiKhoan"><spring:message code="account.bank.number"/>:</label>
              ...
              <div class="form-group row mb-10 show-pass">
                <label class="control-label col-sm-4 col-md-3 col-lg-2" style="margin-left: 2.5em;" for="passWord"><spring:message code="label.password"/>:</label>
                <div class="col-sm-6 col-md-6">
                  <input type="password" class="form-control" id="passWord" name="passWord"
                         placeholder="<spring:message code="change.pass.enter.pass"/>" value="${passWord}" required>
      ...
      <div class="col-md-5">
        <!-- Giao dịch gần nhất -->
        <c:import url="../include_component/frame_information_transaction_topup.jsp" />
        <!-- /Giao dịch gần nhất  -->
      </div>
    </div>
  </div>
