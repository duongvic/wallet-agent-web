      ...
      <div class="col-md-7">
        <div class="panel panel-bordered">
          <div class="panel-body py-10">
            ...
            <form id="confirm-form" class="form-horizontal" method="post" action="/topup/top-up-confirm">
              ...
              <div class="row col mb-20">
                ...
                <%--<div class="col-8 col-sm-7 mb-3">--%>
                  <%--<div class="col-10 col-sm-7 mb-3">--%>
                    ...
                    <%--</span>--%>
                    <%--</br>--%>
                    <%--<span class="small txt-note-pin"><spring:message--%>
              ...
              <div class="row">
                <div class="col-md-9 offset-md-3">
                  <button type="submit" class="btn btn-primary btn-sm pull-right">
                    <spring:message code="common.btn.confirm"/>
                  </button>
                  <a href="/topup"
