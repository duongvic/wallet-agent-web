...
<div class="page">
  <div class="page-header">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a href="#"><spring:message code="topup.page.bread.crum"/></a></li>
    </ol>
    <h3 class="page-title"><spring:message code="topup.page.sub.title"/></h3>
  </div>
      ...
      <div class="col-md-7">
        <div class="panel panel-bordered">
          <div class="panel-body py-10">
            ...
            <form class="form-horizontal" method="post" action="/topup/top-up-next-step-verify">
              ...
              <c:if test="${(codeErr != null) || (param.codeErr != null) }">
              ...
              <div class="form-group row mb-10 ">
                ...
                <div class="col-6 col-sm-7 col-md-9">
                  <label class="" id="soDuVi" name="walletBalance">${ewallet:formatNumber(walletBalance)} đ</label>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-9 offset-md-3">
                  <a class="btn btn-default btn-sm pull-right" href="/topup">
