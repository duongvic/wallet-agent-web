...
<head>
  ...
  %>
  <title><spring:message code="fundout.link.bank.title.page"/></title>
  <!-- head libs  -->
          ...
          <div class="panel-body py-10">
            <form class="form-horizontal" method="post" action="/fundout/request">
              <div class="form-group row mb-10">
                <div class="full-width">
                  ...
                  <div class="text-left">
                    ...
                    <input type="hidden"  id="bankDisplayName" name="bankDisplayName" value="${bankDisplayName}">
              ...
              <div class="form-group row mb-10 pos-relative">
                <input type="hidden" class="form-control" placeholder="<spring:message code="account.bank.number"/>"
              ...
              <div class="form-group row mb-10 pos-relative">
                <input type="text" class="form-control ctk" name="bankAccountName"
              ...
              <div class="form-group row mb-10 pos-relative">
                <input type="text" class="form-control currency-input" id="amount" name="amount" value="${amount != null && amount ne '' ? amount : '100.000 đ'}"
                       placeholder="<spring:message code="fundout.money"/>" required/>

                <label class="form-control-label px-0 label-control-right txt-note-pin vnd"><span id="feeAmount"><spring:message code="label.fee"/>: 0</span></label>
                <input type="hidden" name="feeAmount" id="hidden_feeAmount" value="${feeAmount}">

                <div class="price-radio mt-5">
                  <div class="radio-custom radio-info radio-inline text-center">
                    <input type="radio" id="sdtt1" name="numberdt2" value="100000" ${(amount eq null || amount eq '' || amount eq '100000') ? 'checked=/"checked/"' : ''}
              ...
              <div class="form-group row mb-10 pos-relative">
                <spring:message code="fundout.order.reason" var="reason_string"/>
                <input type="text" class="form-control" name="description" value="${description != null ? description : ''}"
                       placeholder="${reason_string}"/>
              </div>
              ...
              <div class="row mb-10">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 text-right inline-block">
                  <a class="btn btn-default btn-sm mr-10" href="/fundout"> <spring:message code="common.btn.back"/></a>
