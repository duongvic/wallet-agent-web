<%@ page import="static vn.mog.ewallet.consumer.web.controller.bank.BankController.CARD_CONTROLLER_UNLINK" %>
<%@ page import="static vn.mog.ewallet.consumer.web.controller.bank.BankController.BANK_CARD_DELETE" %>
<%@ page
    ...
    <div class="page-content container-fluid">
        <div class="panel mb-0 panel-bordered">
            <%--<form class="form-horizontal" method="post" enctype="multipart/form-data"--%>
                  <%--action="/fundout/${fund_out_method}/management/detail/${request_id}/edit">--%>
                <div class="panel-body">
                    ...
                    <div class="form-group row mb-5">
                        <label class=" col-sm-3 col-form-label pb-0"><spring:message
                                code="fundorder.request.detail.fundout.total.label"/></label>
                        <div class=" col-sm-9 ">
                            <c:choose>
                ...
                <div class="panel-body">
                    <div class="form-group row mb-5">
                        <a class="btn btn-primary btn-sm mr-2"
                           href="/fundout/${fund_out_method}/management"><spring:message
                                code="label.button.title.back"/></a>

                        <c:if test="${0 == stage && 0 == ref_txn_status}">
                            <a class="btn btn-primary btn-sm"
                               href="/fundout/${fund_out_method}/management/detail/${request_id}/edit"><spring:message
