(function (global, factory) {
    ...
    (function () {
        (0, _jquery2.default)('#exampleFullForm').formValidation({
            ...
            , control: {
                ...
                valid: 'is-valid', // The CSS class for invalid control
                invalid: 'is-invalid'
            }
            , row: {
                invalid: 'has-danger'
        ...
        (0, _jquery2.default)('#exampleConstraintsForm, #exampleConstraintsFormTypes').formValidation({
            ...
            , fields: {
                ...
                , type_credit_card: {
                    validators: {
                        creditCard: {
                            message: 'The credit bank number is not valid'
                        }
                    }
                }
                , type_date: {
    ...
    (function () {
        (0, _jquery2.default)('#maxacthuc').formValidation({
            framework: "bootstrap4"
            , icon: null
            , fields: {
                maxacthuc: {
                    validators: {
                        notEmpty: {
                            message: 'Hãy điền mã số xác thực được gửi vào điện thoại'
                        }
                    }
                }
            }
    ...
    // -------------------------------
    (function () {
        (0, _jquery2.default)('.tknganhang-errors').hide();
        (0, _jquery2.default)('#themtknganhang').formValidation({
            framework: "bootstrap4"
            , button: {
            ...
            (0, _jquery2.default)('.tknganhang-errors').html('');
        }).on('err.field.fv', function (e, data) {
            // data.fv     --> The FormValidation instance
            // data.field  --> The field name
            // data.element --> The field element
            (0, _jquery2.default)('.tknganhang-errors').show();
            // Get the messages of field
            var messages = data.fv.getMessages(data.element);
            // Remove the field messages if they're already available
            (0, _jquery2.default)('.tknganhang-errors').find('li[data-field="' + data.field + '"]').remove();
            ...
            (0, _jquery2.default)('.tknganhang-errors > ul').find('li[data-field="' + data.field + '"]').remove();
            if ((0, _jquery2.default)('#themtknganhang').data('formValidation').isValid()) {
                (0, _jquery2.default)('.tknganhang-errors').hide();
            }
        });
    })();
