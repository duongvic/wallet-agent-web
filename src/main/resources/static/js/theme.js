...
$(function () {
	...
	if($('#reservation').length) {
		$("#reportrange span").html($("#reservation").val());
		$('#reportrange').daterangepicker({
			...
			startDate: $("#reservation").val().length > 0 ? $("#reservation").val().substring(0, 10) : '',
			endDate: $("#reservation").val().length > 0 ? $("#reservation").val().substring(13, 23) : '',
			ranges: {
