    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                , messages: {
                    "default": "Tải ảnh"
                    , replace: '<i class="fa fa-camera fs25"></i>'
                    , remove: "Remove"
                    , error: "Lỗi ảnh"
                }
                , error: {
                ...
                , tpl: {
                    ...
                    , preview: '<div class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="mt-0 dropify-infos-message">{{ replace }}</p></div></div></div>'
